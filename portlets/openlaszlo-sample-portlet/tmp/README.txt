...
Here's what you'll find:
    ...
    3rdPartyCredits        - Acknowledgements for 3rd party contributions 
                             to the LPS.
    lps-4.9.0        - Expanded directory containing the 
                             LPS 4.9.0 web app.
    release-notes.html     - Release notes.

Deploy the lps-4.9.0 web application and surf to 

       http://yourhost:yourport/lps-4.9.0/index.html
...
OpenLaszlo 4.9.0 Production branches/4.9@17752 (17752) 2010-10-22T15:20:34Z
